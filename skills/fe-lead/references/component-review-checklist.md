...
- [ ] Is client state managed with Zustand?
...
### OpenAPI + orval Checklist
- [ ] Are generated types used instead of manually defined types?
- [ ] Are generated React Query hooks used instead of manual API calls?
- [ ] Were files in the `api/generated/`, `api/model/` folders not directly modified?
- [ ] Is custom logic handled in wrapper hooks in the `hooks/` folder?
