...
> Examples shown for React/TypeScript. Apply equivalent component patterns for your framework (Vue, Svelte, Angular) as specified in `crew-config.json → frontend.framework`.
