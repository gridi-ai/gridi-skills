...
> Examples shown for Tailwind CSS. Apply equivalent styling patterns for your CSS approach (styled-components, CSS Modules, SCSS) as specified in `crew-config.json → frontend.styling`.
